            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('staff.dashboard') }}">
                        <img src="{{ asset('asset/img/logo.jpg')}}" style="width:60px;height: 60px;">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('staff.report')" :active="request()->routeIs('staff.report')">
                        {{ __('Report') }}
                    </x-nav-link>
                </div>
            </div>
                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <form method="POST" action="{{ url('staff/logout') }}">
                            ...
                            <x-dropdown-link :href="url('staff/logout')"
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                ...
                <form method="POST" action="{{ url('staff/logout') }}">
                    ...
                    <x-responsive-nav-link :href="url('staff/logout')"
                            onclick="event.preventDefault();
                                        this.closest('form').submit();">
                        {{ __('Log Out') }}
                    </x-responsive-nav-link>
